      ...
      setAdmins([
        {
          username: "wounds",
          role: "Admin",
          avatar: "public/images/design-mode/public/images/design-mode/ezqzq0.png",
          telegramLink: "https://t.me/junkjaw",
        },
        {
          username: "dismayings",
          role: "Admin",
          avatar: "public/images/design-mode/public/images/design-mode/ezqzq0.png", // Default avatar for dismayings
          ...
          {admins.map((admin) => (
            ...
            >
              <div className="relative w-[120px] h-[120px] rounded-full overflow-hidden">
                <Image
                  src={admin.avatar || "public/images/design-mode/public/images/design-mode/ezqzq0.png"} // Updated to use new default avatar
              ...
              <div className="flex items-center gap-2">
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: "url('public/images/design-mode/public/images/design-mode/vqvalf.gif')", // Updated to use new red sparkle effect
